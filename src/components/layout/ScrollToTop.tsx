...
export const ScrollToTop = () => {
  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      // ⚡ Bolt Optimization: Debounce scroll events using requestAnimationFrame correctly
      // Avoids over-nesting requestAnimationFrame and properly resets the ticking flag
      // within the async callback to ensure actual debouncing to 60fps
      if (!ticking) {
