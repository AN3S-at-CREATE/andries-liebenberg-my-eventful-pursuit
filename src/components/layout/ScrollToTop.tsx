...
export const ScrollToTop = () => {
  ...
  useEffect(() => {
    ...
    const toggleVisibility = () => {
      // 🚀 Optimizer: Debounce scroll events using requestAnimationFrame to prevent layout thrashing
      if (!ticking) {
    ...
    // 🚀 Optimizer: Added { passive: true } to prevent blocking native scroll performance
