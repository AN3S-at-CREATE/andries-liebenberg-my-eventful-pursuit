...
export const GlobalCursorGlow = ({
  ...
  useEffect(() => {
    // Optimization: Skip event listeners on mobile devices
    if (isMobile) return;
  ...
  // Move useTransform before the conditional return to comply with Rules of Hooks
  ...
  // Optimization: Do not render glow effect on mobile to save rendering and GC overhead
  if (isMobile) {
    return null;
  }
