    ...
    const drawParticles = () => {
      ...
      particlesRef.current.forEach((particle) => {
        ...
        if (particle.size < 1.5) {
          // Use fillRect for small particles to avoid path construction overhead
          ctx.fillRect(
      ...
      // Reset global alpha to avoid side effects on other drawing operations
      ctx.globalAlpha = 1.0;
    };
