...
export function BackgroundFX() {
  ...
  useEffect(() => {
    ...
    let cachedHorizonGradient: CanvasGradient | null = null;
    ...
    const resizeCanvas = () => {
      ...
      cachedHorizonGradient = ctx.createLinearGradient(0, horizonY - 60, 0, horizonY + 60);
      cachedHorizonGradient.addColorStop(0, "rgba(13, 229, 255, 0)");
      cachedHorizonGradient.addColorStop(0.5, "rgba(13, 229, 255, 0.08)");
      cachedHorizonGradient.addColorStop(1, "rgba(13, 229, 255, 0)");

      cachedBottomGradient = ctx.createLinearGradient(0, canvas.height - 150, 0, canvas.height);
      cachedBottomGradient.addColorStop(0, "rgba(255, 26, 140, 0)");
      cachedBottomGradient.addColorStop(0.5, "rgba(255, 26, 140, 0.04)");
      cachedBottomGradient.addColorStop(1, "rgba(255, 26, 140, 0.02)");
    };
