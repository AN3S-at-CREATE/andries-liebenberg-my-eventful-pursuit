// Consolidated data for AN3S Concierge AI Knowledge Base
...
const getMetricsByCompanyId = (companyId: string): CompanyMetric | undefined =>
...
const an3sKnowledge = {
  ...
  companies: companies.map((c) => ({
    ...
    metrics: getMetricsByCompanyId(c.id), // Fixed: Use helper function to find by ID
  })),
};
