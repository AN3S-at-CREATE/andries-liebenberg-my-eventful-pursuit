...
## 2024-05-20 - Add character count for limited inputs
**Learning:** Adding a character count to limited textareas prevents user frustration by providing immediate, visible feedback on constraints before submission errors occur.
**Action:** Always include a visual character count indicator for inputs with a `max` length constraint, positioned clearly near the input.
